            ...
            <div class="product-images">
                @if(!empty($product->images))
                    <div class="main-image mb-4">
                        <img src="{{ $product->image_url }}" alt="{{ $product->name }}" class="w-full h-auto rounded-lg" id="main-product-image">
                    </div>
                ...
                @else
                    <div class="main-image mb-4">
                        <img src="{{ asset('images/placeholder.jpg') }}" alt="{{ $product->name }}" class="w-full h-auto rounded-lg">
                    </div>
                @endif
            </div>
