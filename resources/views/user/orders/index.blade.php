        ...
        <div class="flex flex-col md:flex-row gap-8">
            ...
            <div class="md:w-1/4">
                <div class="bg-white rounded-lg shadow overflow-hidden">
                    ...
                    <div class="p-0">
                        <nav>
                            <a href="{{ route('user.account.index') }}" class="block py-3 px-4 border-r-4 border-transparent hover:bg-gray-50 hover:text-blue-600 hover:border-blue-600">
                                <div class="flex items-center">
                            ...
                            <a href="{{ route('user.orders.index') }}" class="block py-3 px-4 border-r-4 border-blue-600 bg-blue-50 text-blue-600 font-medium">
                                <div class="flex items-center">
                                    <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="md:w-3/4">
                <div class="bg-white rounded-lg shadow overflow-hidden">
                    <div class="p-4 border-b border-gray-200 flex justify-between items-center">
                        <h2 class="text-xl font-semibold">طلباتي</h2>
                        
                        <form action="{{ route('user.orders.index') }}" method="GET" class="flex">
                            <select name="status" onchange="this.form.submit()" 
                                ...
                                <option value="processing" @if(request('status') == 'processing') selected @endif>قيد المعالجة</option>
                                <option value="shipped" @if(request('status') == 'shipped') selected @endif>تم الشحن</option>
                                <option value="delivered" @if(request('status') == 'delivered') selected @endif>تم التسليم</option>
                                <option value="cancelled" @if(request('status') == 'cancelled') selected @endif>ملغي</option>
                            </select>
                        </form>
                    </div>
                    ...
                    <div class="p-6">
                                ...
                                <table class="w-full">
                                    <thead>
                                        <tr class="bg-gray-50">
                                            ...
                                            <th class="py-2 px-4 text-right">المنتجات</th>
                                    ...
                                    <tbody class="divide-y divide-gray-200">
                                        @foreach($orders as $order)
                                            <tr>
                                                ...
                                                <td class="py-3 px-4">{{ $order->items_count }} منتج</td>
                        ...
                        @else
                            <div class="text-center py-8">
                                ...
                                <h3 class="text-lg font-semibold text-gray-700 mb-2">لا توجد طلبات</h3>
                                <p class="text-gray-500 mb-6">لم يتم العثور على أي طلبات تطابق المعايير المحددة</p>
