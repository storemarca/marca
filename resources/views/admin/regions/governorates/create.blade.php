...
<div class="container-fluid px-4">
    <h1 class="mt-4 mb-4">إضافة محافظة جديدة</h1>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.regions.governorates.store') }}" method="POST">
                @csrf
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" name="shipping_cost" id="shipping_cost" class="form-control @error('shipping_cost') is-invalid @enderror" value="{{ old('shipping_cost', 0) }}" step="0.01" min="0" required>
