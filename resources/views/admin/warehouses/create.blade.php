...
@section('title', __('add_warehouse'))
@section('page-title', __('add_warehouse'))
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('admin.warehouses.store') }}" method="POST" id="warehouse-form">
            @csrf
                        ...
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-1"></i> {{ __('save_warehouse') }}
                                </button>
