...
@section('page-title', __('edit_country'))
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('admin.countries.update', $country) }}" method="POST" id="country-form">
            @csrf
            @method('PUT')
            ...
            <div class="row g-4">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="code" id="code" value="{{ old('code', $country->code) }}" required
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="currency_code" id="currency_code" value="{{ old('currency_code', $country->currency_code) }}" required
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="tax_rate" id="tax_rate" value="{{ old('tax_rate', $country->tax_rate) }}" 
                ...
                <div class="col-md-4">
                        ...
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-1"></i> {{ __('update_country') }}
                                </button>
                    ...
                    <div class="card mt-4">
                        <div class="card-header">
                            <h6 class="mb-0">{{ __('country_information') }}</h6>
                        </div>
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item d-flex justify-content-between px-0">
                                    ...
                                    <span class="fw-medium">{{ $country->updated_at->format('Y-m-d') }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
