...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Http\Middleware\CountrySwitcher::class,
    ...
    protected $middlewareAliases = [
        ...
        'localize' => \App\Http\Middleware\LanguageSwitcher::class,
        'country' => \App\Http\Middleware\CountrySwitcher::class,
        'page.cache' => \App\Http\Middleware\PageCache::class,
        'http.cache' => \App\Http\Middleware\HttpCacheHeaders::class,
        'api.headers' => \App\Http\Middleware\ApiResponseHeaders::class,
    ];
} 